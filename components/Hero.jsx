  ...
  return (
    <section className={`relative w-full h-screen mx-auto mt-10`}>
      ...
      >
        ...
        <div >
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className='text-[#915EFF]'>Muhammad Arif</span>
          </h1>
      ...
      <div className='absolute xs:bottom-10 bottom-32 w-full flex justify-center items-center'>
        <a href='#about'>
          <div className='w-[35px] h-[64px] rounded-3xl border-4 border-secondary flex justify-center items-start p-2 mt-80'> 
            <motion.div
              animate={{
                // x:[0,24,0],
                y: [0, 24, 0],
